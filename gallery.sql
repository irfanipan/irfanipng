...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Feb 2024 pada 02.26
...
(2, '', '', '2024-02-06', 2),
(3, 'albumirfan', '', '2024-02-06', 2),
(4, '', '', '2024-02-06', 2),
(5, 'ss', '', '2024-02-06', 2),
(6, 'wwww', 'wwww', '2024-02-06', 2);
...
(2, 'irfan', 'irfan', 'irfan', 'irfan', 'irfan');
...
ALTER TABLE `likefoto`
  ...
  ADD CONSTRAINT `likefoto_ibfk_2` FOREIGN KEY (`UserID`) REFERENCES `komentarfoto` (`UserID`);
COMMIT;
